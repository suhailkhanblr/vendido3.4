...
class UserProvider extends PsProvider {
  ...
  Future<dynamic> postProfileUpdate(
    ...
    _holderUser = await _repo!
        .postProfileUpdate(jsonMap, isConnectedToInternet, PsStatus.SUCCESS);
  ...
  Future<dynamic> postFBLogin(
    ...
    _user = await _repo!
        .postFBLogin(jsonMap, isConnectedToInternet, PsStatus.PROGRESS_LOADING);
  ...
  Future<dynamic> getUserFromDB(String loginUserId) async {
    ...
    await _repo!
        .getUserFromDB(loginUserId, userListStream!, PsStatus.PROGRESS_LOADING);
  }
  ...
  Future<dynamic> blockUser(
    ...
    _apiStatus = await _repo!
        .blockUser(jsonMap, isConnectedToInternet, PsStatus.PROGRESS_LOADING);
  ...
  Future<dynamic> userLogout(
    ...
    _apiStatus = await _repo!
        .userLogout(jsonMap, isConnectedToInternet, PsStatus.PROGRESS_LOADING);
